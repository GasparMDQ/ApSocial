<%@ Page Title="Iniciar sesión" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="Login.aspx.cs" Inherits="VistaWeb.Account.Login" %>
        ...
        <LayoutTemplate>
            ...
            <div class="accountInfo">
                <fieldset class="login">
                    ...
                    <p>
                        <asp:Label ID="EmailLabel" runat="server" AssociatedControlID="UserName">Dirección de Correo:</asp:Label>
                        <asp:TextBox ID="UserName" runat="server" CssClass="textEntry"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="UserNameRequired" runat="server" ControlToValidate="UserName" 
                             CssClass="failureNotification" ErrorMessage="La dirección de correo es obligatoria." ToolTip="La dirección de correo es obligatoria." 
